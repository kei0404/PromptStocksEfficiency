...
const Input: React.FC<InputProps> = ({
  ...
  const getInputStyle = (): any => {
    ...
    if (variant === 'glass') {
      ...
      baseStyle.borderColor = isFocused ? BlueTheme.primary[500] : BlueTheme.primary[200];
    } else {
      baseStyle.backgroundColor = BlueTheme.neutral[50];
      baseStyle.borderWidth = 2;
      baseStyle.borderColor = error ? BlueTheme.semantic.error : isFocused ? BlueTheme.primary[500] : BlueTheme.primary[100];
    }
